...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="model.vo.Member"%>
<%
...
<body>
 ...
 <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
   <a class="navbar-brand" href="index.jsp"> <img src="resources/images/logo.gif" alt="logo" style="width: 120px;">
   </a>
 ...
 %>
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio" style="width: 220px; height: auto;">
       ...
       %>
       <form action="/GoSangEun/OrderDelete.s" method="get" name="deleteOrder" id="DeleteOrder<%=i%>">
        <div class="card">
         ...
         <input type="hidden" name="orderNo" value="<%=nlist.get(i).getOrderId()%>"> <input type="hidden" name="reURI">
       </form>
      </div> <%
 ...
 %>
   ...
   <li class="nav-item"><a class="nav-link dropdown-toggle" href="login.jsp" style="color: #fff;">로그인</a></li>
   </ul>
  </div>
  </div>
 </nav>
 ...
 <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container">
   ...
   <div class="collapse navbar-collapse" id="navbarResponsive">
    <ul class="navbar-nav ml-auto">
     <li class="nav-item active dropdown"><a class="nav-link dropdown-toggle" href="MyPage.jsp" id="navbarDropdownBlog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 장바구니 </a> <!-- servlet으로 이동 -->
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio" style="width: 220px; height: auto;">
       <div class="dropdown-item-text" style="font-size: 18px;">장바구니 목록</div>
       <%
       	int total = 0;
       ...
       <form action="/GoSangEun/OrderDelete.s" method="get" name="deleteOrder" id="DeleteOrder<%=i%>">
        <div class="card">
         ...
         <input type="hidden" name="orderNo" value="<%=olist.get(i).getOrderId()%>"> <input type="hidden" name="reURI"> <input type="hidden" name="USER_ID" value="<%=m.getUSER_ID()%>">
       </form>
      </div> <%
 ...
 %>
   ...
   <li class="nav-item active dropdown"><a class="nav-link dropdown-toggle" href="MyPage.jsp" id="navbarDropdownBlog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img style="width: 25px; height: 25px;" src="resources/images/Rank/<%=m.getRANK()%>.png" alt=""><%=m.getUSER_NICKNAME()%>
   </a>
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
     <a class="dropdown-item" href="ohList.go">나의 정보</a> <a class="dropdown-item" href="ohList.go">주문 확인</a> <a class="dropdown-item" onclick='logout()'>로그아웃</a>
    </div></li>
   </ul>
  </div>
  </div>
