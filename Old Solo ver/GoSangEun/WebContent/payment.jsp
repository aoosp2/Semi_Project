			...
			<div class="col-md-8">
				...
				<div class="pay">
					...
					<div class="delivery_content">
						...
						<input type="text" size="75" name="addr"
							value="<%=m.getUSER_ADDRESS()%>" readonly="readonly"
							disabled="disabled" style="float: left;"><br> <br>
					...
					<div class="order_request">
						<textarea name="textrequest" id="area" rows="4" cols="93"
							placeholder="주문시 요청 사항이 있으시면 남겨주세요."></textarea>
						<!-- textarea 글자수 카운팅 -->
					</div>
					<br>
									...
									<div class="card-header" role="tab" id="headingOne"
										...
										<h5 class="mb-0">
											<img src="resources/images/account.png" alt="account"
												...
												onmouseout="this.style.color='#a6a6a6'"
												data-toggle="collapse" data-parent="#accordion"
												href="#collapseOne" aria-expanded="false"
												aria-controls="collapseOne" class="collapsed">&nbsp; <b>신용/체크카드</b></a>
										</h5>
									</div>
										...
										<div class="card-body">
											...
											<div style="height: 300px;">
												<input type="checkbox" name="checkbox"
													style="margin-left: 45px;">카드 정보 불러오기 <br> <br>
												<ul class="edit" style="list-style-type: none;">
													...
													</select> <!-- <h6>카드번호: &nbsp;</h6> --> <!-- <div class="card-body-sub"></div> -->
														<!-- <h6>카드번호: </h6>
													...
													<li><input type="text" class="cardnum" name="cardnum1"
														style="text-align: center; width: 70px;" maxlength="4"
														oninput="maxLengthCheck(this)" />&nbsp;-&nbsp; <input
														type="text" class="cardnum" name="cardnum2"
														style="text-align: center; width: 70px;" maxlength="4"
														oninput="maxLengthCheck(this)" />&nbsp;-&nbsp; <input
														type="text" class="cardnum" name="cardnum3"
														style="text-align: center; width: 70px;" maxlength="4"
														oninput="maxLengthCheck(this)" />&nbsp;-&nbsp; <input
														type="text" class="cardnum" name="cardnum4"
														style="text-align: center; width: 70px;" maxlength="4"
														oninput="maxLengthCheck(this)" /> <!-- <input type="text" size="4" name="card_1">-<input type="text" size="4" name="card_2">-<input type="text" size="4" name="card_3">-<input type="text" size="4" name="card_3"> -->
													</li>
													<li><br>유효기간 :&nbsp; <input type="month"
														style="width: 140px;"><br></li>
													<br>
													<br>
													<br>
													<li style="margin-left: -220px;"><br>주민번호뒷번호
														:&nbsp; XXXXXX &nbsp; - &nbsp; <input type="text"
														class="cardnum" name="cardnum5"
														style="text-align: center; width: 80px;" maxlength="7"
														oninput="maxLengthCheck(this)" /> <br></li>

													<li style="margin-left: -300px;"><br> <br> <br>
														카드비밀번호 :&nbsp; <input type="password" class="cardnum"
														name="cardnum6" style="width: 50px; text-align: center;"
														maxlength="4" oninput="maxLengthCheck(this)" /></li>
												</ul>
											</div>
										...
										<div class="card-header" role="tab" id="headingTwo"
											...
											<h5 class="mb-0">
												<img src="resources/images/account.png" alt="account"
													...
													data-toggle="collapse" data-parent="#accordion"
													href="#collapseOne" aria-expanded="false"
													aria-controls="collapseOne" class="collapsed">&nbsp; <b>현금</b></a>
											</h5>
										</div>
										<div id="collapseTwo" class="collapse" role="tabpanel"
											aria-labelledby="headingTwo">
											<div class="card-body">현장에서 결제</div>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="card mb-4">
					...
					<div class="card-body" style="height: 150px;">
						...
						<div class="input-group2">
							<label>파닭치킨 x 1개
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								20,000</label><br> <label>양념치킨 x 1개
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								20,000</label><br> <label>배달료
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3,000</label><br>
						</div>
					</div>
