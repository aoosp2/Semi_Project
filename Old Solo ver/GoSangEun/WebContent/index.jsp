		...
		<div class="row">
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="category.go?category=한식"> <img
					src="resources/images/한식.png" alt="img" class="img"
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="category.go?category=중식"> <img
					src="resources/images/중식.jpg" alt="korean" class="img"
					style="position: inherit; top: 0; left: 0; width: 100%; height: 100%; border-radius: 8px;">
					<div class="info">
						<h3>C H I N E S E</h3>
						<p>chinese food</p>
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="category.go?category=족발"> <img
					src="resources/images/족발.jpg" alt="korean" class="img"
					style="position: inherit; top: 0; left: 0; width: 100%; height: 100%; border-radius: 8px;">
					<div class="info">
						<h3>J O C K B A L</h3>
						<p>jockbal</p>
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="category.go?category=치킨"> <img
					src="resources/images/치킨.jpg" alt="korean" class="img"
					style="position: inherit; top: 0; left: 0; width: 100%; height: 100%; border-radius: 8px;">
					<div class="info">
						<h3>C H I C K E N</h3>
						<p>chicken</p>
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="category.go?category=피자"> <img
					src="resources/images/피자.jfif" alt="korean" class="img"
					style="position: inherit; top: 0; left: 0; width: 100%; height: 100%; border-radius: 8px;">
					<div class="info">
						<h3>P I Z Z A</h3>
						<p>pizza</p>
