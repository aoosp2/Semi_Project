...
<body>
 ...
 <input type="hidden" name="" id="MultiCheck" value="true" />
 <form action="/GoSangEun/MultiDelete.s" method="get" id="MultiDel">
  <input type="hidden" name="MultiUserId" value=<%=m.getUSER_ID()%> /> <input type="hidden" name="URL" />
 </form>
 <%
 	break;
 			} else {
   ...
   <div class="col-lg-4">
    <div class=" pre-scrollable" style="max-height: 300px;">
     ...
     <div id="Review">
      ...
      <div class="card mr-2 p-2">
       ...
       %>
       <div class="text-right">
        <a href="#" class="" style="" onclick="UpdateReview();">수정</a> <a href="#" class="" style="color: red;" onclick="DeleteReview();">삭제</a>
        <form action="/GoSangEun/ReviewUpdate.s" method="get" name="rUpdate">
         <input type="hidden" name="No" value="<%=rlist.get(i).getNo()%>"> <input type="hidden" name="shopId" value="<%=s.getShopId()%>"> <input type="hidden" name="Info"> <input type="hidden" name="Point">
        </form>
        <form action="/GoSangEun/ReviewDelete.s" method="get" name="rDelete">
         <input type="hidden" name="No" value="<%=rlist.get(i).getNo()%>"> <input type="hidden" name="shopId" value="<%=s.getShopId()%>">
        </form>
        <script>
    ...
    <div class="text-right" style="font-size: 25px;">
     ...
     <form action="/GoSangEun/Review.s" method="get" name="review">
      <input type="hidden" name="shopId" value="<%=s.getShopId()%>"> <input type="hidden" name="Info"> <input type="hidden" name="userId" value="<%=m.getUSER_ID()%>"> <input type="hidden" name="userName" value="<%=m.getUSER_NICKNAME()%>"> <input type="hidden" name="Point">
     </form>
    </div>
    <script>
  ...
  <div class="row">
   ...
   <div class="col-lg-4 mb-4">
    <div class="card h-100 text-center">
     <img class="card-img-top" src="resources/images/FoodMenu/<%=list.get(num).getCode()%>.jpg" alt="" height="250px;">
     <div class="card-body">
     ...
     <div class="card-footer">
      <form action="/GoSangEun/Order.s" method="get" onsubmit="return OrderCount();" name="addOrder">
       ...
       %>
       <input type="hidden" name="menuNo" value="<%=list.get(num).getNo()%>"> <input type="hidden" name="oCount"> <input type="hidden" name="oSum" value="<%=list.get(num).getPrice()%>"> <input type="submit" value="구매하기" style="font-size: 20px; background: none; padding: 0; border: none; color: rgb(0, 132, 255);">
      </form>
     </div>
    </div>
   </div>
  ...
  <div class="row">
   ...
   <div class="col-lg-2">
    <div class="card text-center h-100">
     <img class="img-thumbnail card-img-top" style="height: 120px;" src="resources/images/FoodMenu/<%=list.get(num2).getCode()%>.jpg" alt="">
     <div class="card-body">
      <h6 class="card-title">
     ...
     <div class="card-footer">
      <form action="/GoSangEun/Order.s" method="get" onsubmit="return OrderCount();">
       ...
       %>
       <input type="hidden" name="menuNo" value="<%=list.get(num2).getNo()%>"> <input type="hidden" name="oCount"> <input type="hidden" name="oSum" value="<%=list.get(num2).getPrice()%>"> <input type="submit" value="구매하기" style="font-size: 20px; background: none; padding: 0; border: none; color: rgb(0, 132, 255);">
      </form>
     </div>
    </div>
   </div>
