	...
	<div class="container">
		<div class="row">
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="ShopList.jsp"> <img src="resources/images/한식.png"
					alt="img" class="img"
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="ShopList.html"> <img src="resources/images/일식.jpg"
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="ShopList.html"> <img src="resources/images/중식.jpg"
					alt="korean" class="img"
					style="position: inherit; top: 0; left: 0; width: 100%; height: 100%; border-radius: 8px;">
					<div class="info">
						<h3>C H I N E S E</h3>
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="ShopList.html"> <img src="resources/images/피자.jfif"
					alt="korean" class="img"
					style="position: inherit; top: 0; left: 0; width: 100%; height: 100%; border-radius: 8px;">
					<div class="info">
						<h3>P I Z Z A</h3>
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="ShopList.html"> <img src="resources/images/치킨.jpg"
					alt="korean" class="img"
					style="position: inherit; top: 0; left: 0; width: 100%; height: 100%; border-radius: 8px;">
					<div class="info">
						<h3>C H I C K E N</h3>
			...
			<div class="ih-item square effect13 left_to_right">
				<a href="ShopList.html"> <img src="resources/images/족발.jpg"
					alt="korean" class="img"
					style="position: inherit; top: 0; left: 0; width: 100%; height: 100%; border-radius: 8px;">
					<div class="info">
						<h3>J O C K B A L</h3>
	...
	<footer class="py-5 bg-dark">
		<div class="container">
			<p class="m-0 text-center text-white">
				© (안) 정식 없는 KH 정식 &nbsp;&nbsp; 2019 All Right Reserved <br>
				&lt; 서울시 강남구 태헤란로 14-6 &gt; <br> E-mail: xxxx@xxxx.co.kr
				&nbsp;&nbsp; ☎02-123-4567
			</p>
		</div>
		<!-- /.container -->
